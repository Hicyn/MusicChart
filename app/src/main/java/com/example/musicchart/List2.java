...
public class List2 extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        if(position ==0){
           ...
           /* //测试数据库
            ...
            intent.setData(Uri.parse("https://www.baidu.com/?tn=78040160_15_pg&ch=13"));
            startActivity(intent);
        }else if(position == 2){
            Intent intent = new Intent(Intent.ACTION_VIEW);
            intent.setData(Uri.parse("https://123.sogou.com/"));
            startActivity(intent);
        }
